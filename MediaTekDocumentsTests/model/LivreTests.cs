...
namespace MediaTekDocuments.model.Tests
{
    ...
    public class LivreTests
    {
        ...
        {
            Assert.AreEqual(id, livre.Id, "devrait réussir");
            Assert.AreEqual(titre, livre.Titre, "devrait réussir");
            Assert.AreEqual(image, livre.Image, "devrait réussir");
            Assert.AreEqual(isbn, livre.Isbn, "devrait réussir");
            Assert.AreEqual(auteur, livre.Auteur, "devrait réussir");
            Assert.AreEqual(collection, livre.Collection, "devrait réussir");
            Assert.AreEqual(idGenre, livre.IdGenre, "devrait réussir");
            Assert.AreEqual(genre, livre.Genre, "devrait réussir");
            Assert.AreEqual(idPublic, livre.IdPublic, "devrait réussir");
            Assert.AreEqual(lePublic, livre.Public, "devrait réussir");
            Assert.AreEqual(idRayon, livre.IdRayon, "devrait réussir");
            Assert.AreEqual(rayon, livre.Rayon, "devrait réussir");
        }
    }
}