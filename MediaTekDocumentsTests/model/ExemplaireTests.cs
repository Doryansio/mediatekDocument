...
namespace MediaTekDocuments.model.Tests
{
    ...
    public class ExemplaireTests
    {
        ...
        {
            Assert.AreEqual(numero, exemplaire.Numero, "devrait réussir");
            Assert.AreEqual(photo, exemplaire.Photo, "devrait réussir");
            Assert.AreEqual(dateAchat, exemplaire.DateAchat, "devrait réussir");
            Assert.AreEqual(idEtat, exemplaire.IdEtat, "devrait réussir");
            Assert.AreEqual(id, exemplaire.Id, "devrait réussir");
        }
    }
}